...
Flare.create(user_id:1,content:"Thank you to the Flatiron coaches and instructors.",image_url:"https://media.giphy.com/media/IVwloY4CS1Pvq/giphy.gif",interacts:720,😎:1200)
...
Response.create(user_id:4,flare_id:2,content:"Shoutout the whole staff. Not all heroes wear capes.")
Response.create(user_id:10,flare_id:2,content:"I want to go to Flatiron")
